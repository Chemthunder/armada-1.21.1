...
public interface ArmadaEnchantments {
  //  RegistryKey<Enchantment> TRANSFER = create("transfer");
...
//
//        registerable.register(TRANSFER, Enchantment.builder(Enchantment.definition(
//                                itemLookup.getOrThrow(ArmadaTags.WARDING),
//                                2,
//                                1,
...
//                        ))
//                        .addEffect(ArmadaEnchantmentEffects.WARDING)
//                        .build(TRANSFER.getValue())
//        );
    }
}
