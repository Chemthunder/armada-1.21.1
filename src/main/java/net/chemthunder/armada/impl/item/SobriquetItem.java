...
public class SobriquetItem extends ArmadaItem implements ModelVaryingItem, CustomHitParticleItem, CustomHitSoundItem {
    public static final SweepParticleEffect[] EFFECTS = new SweepParticleEffect[]{
            new SweepParticleEffect(0x6a585c, 0x312b2e),
            new SweepParticleEffect(0x1e191c, 0x171013)
    };

    public SobriquetItem(Settings settings) {
        super(settings, 0xFF2e2e2e, 0xFF1f1d1d, 0xF0000000);
    }
