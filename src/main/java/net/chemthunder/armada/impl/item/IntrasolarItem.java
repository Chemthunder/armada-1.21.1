...
public class IntrasolarItem extends ArmadaItem implements ModelVaryingItem {
    public IntrasolarItem(Settings settings) {
        super(settings, 0xFF2c3241, 0xFF808d95, 0xF0110c18);
    }

    public Identifier getModel(ModelTransformationMode renderMode, ItemStack stack, @Nullable LivingEntity entity) {
        return MiscUtils.isGui(renderMode) ? Armada.id("intrasolar") : Armada.id("intrasolar_handheld");
    }

    public List<Identifier> getModelsToLoad() {
        return Arrays.asList(
                Armada.id("intrasolar"),
                Armada.id("intrasolar_handheld")
        );
    }
